    ...
    <div className="max-w-4xl mx-auto space-y-12">
      <header className="text-center space-y-6">
        ...
        <div className="relative max-w-xl mx-auto">
          ...
          <input 
            ...
            className="w-full bg-white/5 border border-white/10 rounded-2xl pl-12 pr-6 py-4 text-white focus:outline-none focus:ring-2 focus:ring-emerald-500/50"
          />
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <button className="bg-[#0F0F12] border border-white/5 rounded-3xl p-8 text-left hover:bg-white/[0.02] transition-all group">
          ...
          <ChevronRight className="w-4 h-4 text-slate-700 group-hover:text-emerald-400 transition-all" />
        </button>
        <button className="bg-[#0F0F12] border border-white/5 rounded-3xl p-8 text-left hover:bg-white/[0.02] transition-all group">
      ...
      <section className="space-y-6">
        <h3 className="text-xl font-bold text-white flex items-center gap-2">
          <HelpCircle className="w-5 h-5 text-emerald-400" /> 常见问题
        </h3>
